...
Before you can install this package, you will need to create a github account. It's free to do. Let Tim know once you do and he will invite you as a collaborator. Otherwise you will not be able to install the package as it is in a non-public repository
...
You might do this to get and plot tag hits. You  may need to change the path to your copy of the .motus file or depending on how it is mapped on your computer.
